...
public class TransaksiDua extends javax.swing.JPanel {
...
ResultSet rs;
if (nm_plg.getText() == null ) {
    JOptionPane.showMessageDialog(null, "Silakan mengisikan nama pelanggan terlebih dahulu!");
...
try {
    ...
    private void initComponents() {
        ...
        judul14.setText("Nama Pelanggan");
        ...
        judul13.setText("Mencari Sesuai Tanggal Pesan  ?");
